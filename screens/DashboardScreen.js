      ...
      <SafeAreaView style={(styles.container2, { marginTop: top })}>
        ...
        {dataSource.length !== 0 ? (
            ...
            renderItem={({ item }) => (
              <View
                ...
                <Image
                  ...
                  source={{
                    uri: 'https://hook.finance/sites/default/files/user.png'
                  }}
                />
              </View>
            )}
          ...
          <View
            ...
            <Text style={{ fontSize: 30, color: '#3B83BD' }}>
              ¡Hola {userData.name}!
            </Text>
            <Text style={{ fontSize: 20, color: '#3B83BD' }}>
              Aún no tienes objetos creados
            </Text>
          </View>
        )}
        {/* <Loading/> */}
